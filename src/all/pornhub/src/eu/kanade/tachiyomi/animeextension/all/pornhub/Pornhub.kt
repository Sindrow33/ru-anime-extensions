...
class Pornhub :
    ...
    override fun popularAnimeRequest(page: Int): Request = GET("https://es.pornhub.com/video?o=tr&page=$page", headers)

    override fun popularAnimeFromElement(element: Element): SAnime {
        val anime = SAnime.create()
        anime.setUrlWithoutDomain("$baseUrl${element.select("div.wrap div.phimage a").attr("href")}")
    ...
    override fun searchAnimeRequest(page: Int, query: String, filters: AnimeFilterList): Request = GET("$baseUrl/video/search?search=$query&page=$page", headers)
    ...
    private fun fromHtml(html: String?): Spanned = if (html == null) {
        SpannableString("")
